...
| M8 | 诊断深化与知识固化 | M8.1 ✅；T014 ✅ Done（verified LKGC `cc8393a`）；T015 🔄（IN PROGRESS 整体；**Phase A/B ✅ DONE / REVIEW PASS**；verified LKGC `02ce302`；Part C 0x10 NOT STARTED）；后续（Replay v2 timing / UART / register-map）⏸ | 🔄 进行中 |
