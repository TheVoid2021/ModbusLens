...
| M5 | 回放与串口模式 | T009, T010 | 🔄 进行中（T009 ✅ / T010 Part A ✅ DONE / Part B 未开始） |
...
→ T008 Qt UI ✅ → T009 Replay ✅ → T010 Serial（Part A ✅ → Part B UI） → T011 AI Diagnosis
