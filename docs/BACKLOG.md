...
| M6 | AI 诊断与 Agent 工具 | T011, T012 | 🔄 进行中（T011 Part A ✅ / Part B Learning+Test Design；T012 未开始） |
| M7 | 收尾与演示 | T013 | ⬜ |
...
→ T008 Qt UI ✅ → T009 Replay ✅ → T010 Serial ✅ → T011 AI Diagnosis（Part A ✅ / Part B Learning+Test Design 完成 → Implementation） → T012 Agent Tools → T013 Final Integration & Demo
