...
| M5 | 回放与串口模式 | T009, T010 | 🔄 进行中（T009 ✅ / T010 Part A ✅ / Part B Learning+Test Design） |
...
→ T008 Qt UI ✅ → T009 Replay ✅ → T010 Serial（Part A ✅ / Part B Learning+Test Design 完成 → Implementation） → T011 AI Diagnosis
