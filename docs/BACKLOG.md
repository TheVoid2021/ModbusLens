...
| M6 | AI 诊断与 Agent 工具 | T011, T012 | 🔄 进行中（T011 ✅ DONE / T012 未开始） |
| M7 | 收尾与演示 | T013 | ⬜ |
...
| T012 | **Agent Tools** | M6 | P2 | In Progress（Part A ✅ DONE；Part B Phase 1 ✅ DONE；**Phase 2 IMPLEMENTED / ISSUE-007 FIXED / AWAITING LIVE RE-VALIDATION（`e922c19`）**） | T007/T008/T011 输出 | 只读 Agent 工具集：三工具 white-list（summary/anomalies/detail）；架构强制**无写能力连名字都不在 contract**；详见 T012 档案 + ADR002 |
