...
| T012 | **Agent Tools** | M6 | P2 | In Progress（Part A ✅ DONE；Part B Phase 1 ✅ DONE；**Phase 2 IMPLEMENTED / AWAITING MANUAL UI REVIEW（`d781ab0`）**） | T007/T008/T011 输出 | 只读 Agent 工具集：三工具 white-list（summary/anomalies/detail）；架构强制**无写能力连名字都不在 contract**；详见 T012 档案 + ADR002 |
