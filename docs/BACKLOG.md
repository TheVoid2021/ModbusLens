...
| M6 | AI 诊断与 Agent 工具 | T011, T012 | ✅ 完成（T011 ✅ + T012 ✅；ISSUE-006/007 RESOLVED） |
| M7 | 收尾与演示 | T013 | ⬜ |
...
| T012 | **Agent Tools** | M6 | P2 | ✅ Done（用户 Final Review PASS；verified LKGC `e922c19`；ISSUE-007 RESOLVED） | T007/T008/T011 输出 | 只读 Agent 工具集：三工具 white-list（summary/anomalies/detail）；架构强制**无写能力连名字都不在 contract**；详见 T012 档案 + ADR002 |
